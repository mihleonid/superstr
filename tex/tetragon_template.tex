...
\begin{tikzpicture}[>=latex, xscale=\tkizx, yscale=\tkizy]
	...
	\node[rectangle, draw, color_border, inner sep=5pt] (b) at (11,7) {\color{color_string} @};
	\node[rectangle, draw, color_border, inner sep=5pt] (c) at (11,1) {\color{color_string} @};
	\node[rectangle, draw, color_border, inner sep=5pt] (d) at (5,1) {\color{color_string} @};
	%~ for drawing a->a
