...
\begin{tikzpicture}[>=latex, xscale=\tkizx, yscale=\tkizy]
	\node[rectangle, draw, color3, inner sep=5pt] (a) at (8,7) {\color{red} @};
	\node[rectangle, draw, color3, inner sep=5pt] (b) at (12,1) {\color{red} @};
	\node[rectangle, draw, color3, inner sep=5pt] (c) at (4,1) {\color{red} @};
	%~ for drawing a->a
