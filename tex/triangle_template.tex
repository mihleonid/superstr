...
\begin{tikzpicture}[>=latex, xscale=\tkizx, yscale=\tkizy]
	\node[rectangle, draw, color3, inner sep=5pt] (a) at (8,7) {\color{color0} stra};
	\node[rectangle, draw, color3, inner sep=5pt] (b) at (12,1) {\color{color0} strb};
	\node[rectangle, draw, color3, inner sep=5pt] (c) at (4,1) {\color{color0} strc};
